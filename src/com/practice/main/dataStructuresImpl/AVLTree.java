...
public class AVLTree<T extends Comparable<T>> extends BinarySearchTree<T>
{
    ...
    @Override
    protected BinaryNode<T> insert(BinaryNode<T> root, T dataToBeInserted) {
        return balance(super.insert(root,dataToBeInserted));
    }
    ...
    public static void main(String[] args) {
		...
		treePrinter = new TreePrinter(avlTree);
		treePrinter.print("AVL Tree");
	}
}
